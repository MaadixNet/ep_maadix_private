...
jQuery(document).ready(function(){
        ...
        $(window).resize(function() {
         ...
         $(window).resize(function() {
          ...
          //remove readonly attribute to input fileds (used to avoid firfox autofilling
          $(':input').each(function(){
                ...
                var url;
                        ...
                        post(data, url+'/updateprofile' ,function(data){
                                        if(data.success){
                                                ...
                                                if(data.error == 'Unable to update user'){
...
//                                              console.log(data);
      ...
      $('td.userGroupRole').each(function(){
          ...
          var textrole = userRole(roleid)
            $(this).addClass(textrole);
            $(this).html('');
            $(this).html(textrole);
            console.log('textrole ' + textrole + ' idrole ' + roleid );
      });
